...
//
//public class TsMainActivity2 extends Activity implements View.OnClickListener, View.OnLongClickListener {
//
//    private static final String TAG = TsMainActivity2.class.getSimpleName();
...
//         tv_error = (TextView) mDialog.getWindow().getDecorView().findViewWithTag("errtxt");
//    }
//
